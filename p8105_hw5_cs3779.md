...
<img src="p8105_hw5_cs3779_files/figure-gfm/unnamed-chunk-3-1.png" width="90%" />

**Notes:** Comparing the treatment arm to the control arm, it seems that
by the end of the 8 week observation period that the treatment arm had
on average higher values than the control arm. Additionally, both groups
started with around the same values, but began separating after the

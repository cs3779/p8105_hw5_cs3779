...
estimated beta increased in size.
...
**Notes:** Amongst the samples in which the null hypothesis was
rejected, the average estimated beta across tests became closer to the
true value of the beta as the value of the tested beta increased
(i.e. the estimated and true values of beta are far apart for beta = 1,
but are much closer when beta = 6). The reason for this is because
larger effect sizes are easier to detect, and because of the large
number of samples taken, the average estimate should be closer and
